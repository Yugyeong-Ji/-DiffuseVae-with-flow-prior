...
#                         dataset.ddpm.model.n_heads=8 \
#                         dataset.ddpm.evaluation.seed=0 \
#                         dataset.ddpm.evaluation.sample_prefix='' \
#                         dataset.ddpm.evaluation.device=\'gpu:0\' \
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'/data/jupyter/yeon/DiffuseVAE/diffusevae_cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3/checkpoints/ddpmv2-cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3-epoch=2849-loss=0.0250.ckpt\' \
#                         dataset.ddpm.evaluation.type='uncond' \
...
#                         dataset.ddpm.evaluation.save_path=\'/data/jupyter/yeon/DiffuseVAE/ddpm_cifar10_benchmark_speedvsquality/uncond/\' \
#                         dataset.ddpm.evaluation.n_samples=50000 \
#                         dataset.ddpm.evaluation.n_steps=1000 \
#                         dataset.ddpm.evaluation.workers=2 \

python main/eval/ddpm/sample_cond_nvp.py +dataset=cifar10/test \
                        dataset.ddpm.data.norm=True \
                        ...
                        dataset.ddpm.evaluation.device=\'gpu:0\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/data/jupyter/yeon/DiffuseVAE/vae_nvp_ddpm/ema_checkpoints/ema-epoch=249-loss=0.0000.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.sample_from='target' \
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=32 \
                        dataset.ddpm.evaluation.save_path=\'/data/jupyter/yeon/DiffuseVAE/2550_nvp2\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=2500 \
                        dataset.ddpm.evaluation.n_steps=1000 \
                        dataset.ddpm.evaluation.save_vae=True \
                        dataset.ddpm.evaluation.workers=1 \
                        dataset.vae.evaluation.chkpt_path=\'/data/jupyter/yeon/DiffuseVAE/vae_cifar10_alpha=1.0/checkpoints/vae-cifar10_alpha=1.0-epoch=1499-train_loss=0.0000.ckpt\' \
...
#                         dataset.ddpm.evaluation.device=\'gpu:0\' \
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'/data/jupyter/yeon/DiffuseVAE/vae_ddpm/ema_checkpoints/ema-epoch=619-loss=0.0000.ckpt\' \
#                         dataset.ddpm.evaluation.type='form1' \
#                         dataset.ddpm.evaluation.resample_strategy='truncated' \
#                         dataset.ddpm.evaluation.skip_strategy='quad' \
#                         dataset.ddpm.evaluation.sample_method='ddpm' \
...
#                         dataset.ddpm.evaluation.save_path=\'/data/jupyter/yeon/DiffuseVAE/2550_eval/\' \
#                         dataset.ddpm.evaluation.z_cond=False \
#                         dataset.ddpm.evaluation.n_samples=2500 \
#                         dataset.ddpm.evaluation.n_steps=1000 \
#                         dataset.ddpm.evaluation.save_vae=True \
