...
# python /home/dxlab/jupyter/hanyong/DiffuseVAE/main/eval/ddpm/sample.py +dataset=cifar10/test \
#                         --config-dir /home/dxlab/jupyter/hanyong/DiffuseVAE/main/configs/dataset/cifar10 \
#                         --config-name test.yaml \
#                         +dataset.ddpm.data.image_size=32 \
#                         +dataset.ddpm.data.norm=True \
#                         +dataset.ddpm.model.beta1=0.1 \
#                         +dataset.ddpm.model.dim=160 \
#                         +dataset.ddpm.model.beta2=0.999 \
...
#                         +dataset.ddpm.evaluation.device=\'gpu:0\' \
#                         +dataset.ddpm.evaluation.save_mode='image' \
#                         +dataset.ddpm.evaluation.chkpt_path=\'/home/dxlab/jupyter/hanyong/DiffuseVAE/diffusevae_cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3/checkpoints/ddpm_cifar10_uncond_loss=0.0618.ckpt\' \
#                         +dataset.ddpm.evaluation.type='uncond' \
...
#                         +dataset.ddpm.evaluation.save_path=\'/home/dxlab/jupyter/hanyong/DiffuseVAE/ddpm_cifar10_benchmark_speedvsquality/uncond/\' \
#                         +dataset.ddpm.evaluation.n_samples=2500 \
#                         +dataset.ddpm.evaluation.n_steps=100 \
#                         +dataset.ddpm.evaluation.workers=1 \

# python /home/dxlab/jupyter/hanyong/DiffuseVAE/main/eval/ddpm/sample.py \
#     --config-dir /home/dxlab/jupyter/hanyong/DiffuseVAE/main/configs/dataset/cifar10 \
#     --config-name test.yaml \
#     dataset.ddpm.data.image_size=32 \
#     dataset.ddpm.data.norm=True \
...
#     dataset.ddpm.evaluation.device="'gpu:0'" \
#     dataset.ddpm.evaluation.save_mode="'image'" \
#     dataset.ddpm.evaluation.chkpt_path="'/home/dxlab/jupyter/hanyong/DiffuseVAE/diffusevae_cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3/checkpoints/diffvae_cifar10_form2_loss=0.0185.ckpt'" \
#     dataset.ddpm.evaluation.type="'uncond'" \
#     dataset.ddpm.evaluation.variance="'fixedsmall'" \
#     dataset.ddpm.evaluation.resample_strategy="'spaced'" \
#     dataset.ddpm.evaluation.skip_strategy="'quad'" \
...
#     dataset.ddpm.evaluation.sample_from="'target'" \
#     dataset.ddpm.evaluation.batch_size=64 \
#     dataset.ddpm.evaluation.save_path="'/home/dxlab/jupyter/hanyong/DiffuseVAE/ddpm_cifar10_benchmark_speedvsquality/uncond2/'" \
#     dataset.ddpm.evaluation.n_samples=2500 \
#     dataset.ddpm.evaluation.n_steps=100 \
#     dataset.ddpm.evaluation.workers=1


python /home/dxlab/jupyter/hanyong/DiffuseVAE/main/eval/ddpm/sample_cond_ori.py \
    --config-dir /home/dxlab/jupyter/hanyong/DiffuseVAE/main/configs/dataset/cifar10 \
    --config-name test.yaml \
    dataset.ddpm.data.image_size=32 \
    dataset.ddpm.data.norm=True \
    ...
    dataset.ddpm.evaluation.sample_from="'target'" \
    dataset.ddpm.evaluation.batch_size=64 \
    dataset.ddpm.evaluation.save_path="'/home/dxlab/jupyter/hanyong/DiffuseVAE/ddpm_cifar10_benchmark_speedvsquality/uncond/form1/2550/'" \
    dataset.ddpm.evaluation.n_samples=2500 \
    ...
    dataset.ddpm.evaluation.z_cond=False \
    dataset.ddpm.evaluation.save_vae=True \
    dataset.vae.evaluation.chkpt_path="'/home/dxlab/jupyter/hanyong/DiffuseVAE/vae_cifar10_alpha=1.0/checkpoints/vae_cifar10_loss=0.00.ckpt'" \
    +dataset.vae.evaluation.expde_model_path="'/home/dxlab/jupyter/hanyong/DiffuseVAE/expde_gmm/gmm_50.joblib'"
